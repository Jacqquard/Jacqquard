...
💻 Языки: Python, JavaScript, C++, SQL, Java<br>
🔧 Фреймворки: React, Django, Flask, FastAPI<br>
🗄️ Базы данных: PostgreSQL, MySQL, SQLite<br>
⚙️ Инфраструктура: Docker, Linux, Git, Node.js<br>
🔄 Прочее: HTML5, CSS3, REST API, WebSockets, Asyncio<br>
